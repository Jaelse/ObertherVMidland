...
cease_collection_of_debt(DEBT_COLLECTOR, CONSUMER) :- 
    notifies(CONSUMER, DEBT_COLLECTOR, dispute(CONSUMER, validity_of_debt)),
...
violates(DEBT_COLLECTOR, "15 U.S.C sec. 1692g(b)") :-
    overshadow(
        communication(DEBT_COLLECTOR, CONSUMER, MEDIUM, CONTENT),
